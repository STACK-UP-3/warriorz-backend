...
if(Math.round(Pages) === parseInt((Pages),10) && parseInt((Pages),10) !== Pages){
  
    results.pageInformation =`You are on Page ${page} of ${ Math.round(Pages) + 1} Pages`;
  }else {
    results.pageInformation =`You are on Page ${page} of ${ Math.round(Pages)} Pages`;
  }
